    ...
    def start(self):      # Aloitetaan ohjelma
        if DOORNUMBER < 3:  # Jos ovia on valittu vähemmän kuin kaksi ohjelma ei aukea
            ...
            message="This is Monty Hall problem. Behind one door there is a price. "
                    "Other doors leave you nothing. "
                    "Choose the door with price, then press 'PLAY'. Monty will open wrong "
                    "doors. After that you got to choose again. This time whether you want to stick or change "
                    "your choise. Press 'RESULT' to open last two doors. GOOD LUCK!")
